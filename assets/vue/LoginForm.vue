	...
	>
		...
		<div class="mb-4">
			...
			<input
				...
				type="email"
				placeholder="Email">
			<p class="mt-1 text-xs text-gray-500">Try: <a href="#" tabindex="-1" @click.prevent="loadEmailField">bernie@dragonmail.com</a>
			</p>
		</div>
		<div class="mb-6">
			...
			>
			<p class="mt-1 text-xs text-gray-500">Try: <a href="#" tabindex="-1" @click.prevent="loadPasswordField">roar</a>
			</p>
		</div>
